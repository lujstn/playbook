...
chk "! grep -qE '(^|[^-])design\\.md' '$S'" "no bare lowercase design.md (canonical is DESIGN.md)"
chk "grep -q 'DESIGN\\.md' '$S'" "canonical doc named DESIGN.md"
...
WI="$root/skills/synchronised-subagent-development/prompts/wave-integration-reviewer.md"
chk "grep -q 'scaffolding_comment_leak' '$WI'" "wave-integration reviewer gates scaffolding-comment leak (tenet 6 promotion gate)"
CQ="$root/skills/synchronised-subagent-development/prompts/code-quality-reviewer.md"
chk "grep -qi 'reference the plan, a wave, a phase' '$CQ'" "code-quality reviewer already gates tenet 6 (unchanged)"
...
chk "! grep -qE '(^|[^-])design\\.md' '$O'" "offline-mode no bare lowercase design.md (canonical is DESIGN.md)"
...
chk "! grep -qE '(^|[^-])design\\.md' '$H'" "hackathon-team no bare lowercase design.md (canonical is DESIGN.md)"
chk "grep -q 'DESIGN\\.md' '$H'" "hackathon-team canonical doc named DESIGN.md"
R="$root/README.md"
