...
chk "! grep -qE '(^|[^-])design\\.md' '$H'" "hackathon-team no bare design.md, plan-a-design.md allowed"
chk "grep -q 'plan-a-design\\.md' '$H'" "hackathon-team canonical doc named plan-a-design.md"
R="$root/README.md"
