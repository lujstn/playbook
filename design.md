...
>
> One additional idea worth considering: an edit-file hook that prompts Claude to continually update an uncertainty score (e.g. 0–100). Minimal context cost — just a number — but useful as a signal for when to escalate to a CTO subagent or the user.
>
